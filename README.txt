...
- best compiler for common (as of 2025-10-27)

____________
| Usage    |
------------
simply create a file (really, any file!), we'll use a simple`common_test.txt` file here, 
on linux do:
...
now the good part, actually using the common compiler! for C/C++ comments, simply do 

	$ common common_test.txt

and out pops a `common_test.com` file!
"b-but what if I want to use python-style comment" you ask? worry not, common has lots of flags that 
enable it to parse all kinds of comment styles :D 
